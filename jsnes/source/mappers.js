...
JSNES.Mappers[0].prototype = {
    reset: function() {
        ...
        this.joy3StrobeState = 0;
        this.joy4StrobeState = 0;
    ...
    load: function(address) {
        ...
        switch (this.joy4StrobeState) {
            ...
            case 6:
            case 7:
                ret = this.nes.keyboard.state4[this.joy4StrobeState];
                break;
            case 8:
            case 9:
            case 10:
        ...
        this.joy4StrobeState++;
        if (this.joy4StrobeState == 24) {
            this.joy4StrobeState = 0;
        }
    ...
    joy3Read: function() {
        ...
        switch (this.joy3StrobeState) {
            ...
            case 6:
            case 7:
                ret = this.nes.keyboard.state3[this.joy3StrobeState];
                break;
            case 8:
            case 9:
            case 10:
        ...
        this.joy3StrobeState++;
        if (this.joy3StrobeState == 24) {
            this.joy3StrobeState = 0;
        }
            ...
            case 4:
                ...
                switch (address - 0x4015) {
                    ...
                    case 1:
                     ...
                     //   var res = this.joy1Read() + this.joy3Read();
                     //   var res = (this.joy1Read() & 1) + 2049;
                  //      console.log(res);
                        const res = ((this.joy1Read() & 1) + (this.joy3Read() & 1) * 2)
                        return res;
                    ...
                    case 2:
                        ...
                        if (this.mousePressed) {
                            ...
                            return ((this.joy2Read() & 1) + (this.joy4Read() & 1) * 2)
                        }
    ...
    joy2Read: function() {
        let ret = 0;
        let s = this.joy2StrobeState;

        if (s >= 0 && s < 8) {
            ret = this.nes.keyboard.state2[s]; // Игрок 2
        } else if (s >= 8 && s < 16) {
            ret = this.nes.keyboard.state3[s - 8]; // Игрок 3
        } else if (s >= 16 && s < 24) {
            ret = this.nes.keyboard.state4[s - 16]; // Игрок 4
        } else if (s == 24) {
            ret = 1;
        }
    ...
    toJSON: function() {
        return {
            ...
            'joy3StrobeState': this.joy3StrobeState,
            'joy4StrobeState': this.joy4StrobeState,
    ...
    fromJSON: function(s) {
        ...
        this.joy3StrobeState = s.joy3StrobeState;
        this.joy4StrobeState = s.joy4StrobeState;
